...
INSERT INTO Doctors VALUES (1, 'Jan', 'Kowalski', 654321, 'internista', false);
INSERT INTO Doctors VALUES (2, 'Maria', 'Borowska', 742148, 'ginekolog', true);
INSERT INTO Doctors VALUES (3, 'Elzbieta', 'Kalinowska', 854317, 'pediatra', false);
...
INSERT INTO Prescriptions VALUES (1, 'Lekarstwo na bol gardla', 3342, '2022-06-30', '2022-07-30', 1, 2);
...
ALTER TABLE Prescriptions ADD CONSTRAINT Prescriptions_fk1 FOREIGN KEY (patient_id) REFERENCES Patients(patient_id);
